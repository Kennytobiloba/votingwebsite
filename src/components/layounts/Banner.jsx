...
const Banner = () => {
  return (
    <div>
      <div className="banner-bottom1 mt-8">
           ...
           border-t-red-600  transition duration-300 hover:border-t-white hover:bg-red-500">
            <div className="flex items-center justify-center text-center">
              ...
              <div className="ml-4">
                ...
                <h3 className="text-[20px] md:text-[22px] text-red-black lg:text-[24px]  mb-2">
                  Accessibility
                </h3>
                <p className="text-black text-sm md:text-base lg:text-lg">
                  Lorem Ipsum is therefore always free.
           ...
           border-t-purple-600  transition duration-300 hover:border-t-white hover:bg-[#c05fe6]">
            <div className="flex items-center justify-center text-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-black text-sm md:text-base lg:text-lg">
                  Lorem Ipsum is therefore always free.
                </p>
              </div>
            </div>
